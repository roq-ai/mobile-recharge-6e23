...
import { getCustomerServiceById } from 'apiSdk/customer-services';
import { CustomerServiceInterface } from 'interfaces/customer-service';

function CustomerServiceViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Customer Service Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('customer_service', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/customer-services/edit/${id}`} passHref legacyBehavior>
                    <Button
