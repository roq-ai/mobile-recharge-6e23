  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless transactions with Mobile Recharge App - Maxi. Your one-stop solution for mobile recharge and bill payments with rewarding cashbacks on every recharge."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1622534138722-895a7deb9f49?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtb2JpbGUlMjByZWNoYXJnZXxlbnwwfHx8fDE2OTY4MjIzNzJ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless transactions with Mobile Recharge App - Maxi. Your one-stop solution for mobile recharge and bill payments with rewarding cashbacks on every recharge.`}
            </Text>
            <Box
