...
export function ProviderListPage(props: ProviderListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getProviders({
        relations: ['user', 'bill_payment.count', 'recharge.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('bill_payment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'bill_payment',
          header: 'Bill Payment',
          accessorKey: 'bill_payment',
          cell: ({ row: { original: record } }: any) => record?._count?.bill_payment,
        }
      : null,
    hasAccess('recharge', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'recharge',
          header: 'Recharge',
          accessorKey: 'recharge',
          cell: ({ row: { original: record } }: any) => record?._count?.recharge,
        }
      : null,
